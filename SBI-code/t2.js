...
function encryptAndSendPayload() {
  ...
  console.log('[Step 1] AES Key:', aesKey.toString('hex'));
  ...
  console.log('[Step 2] Encrypted Payload:', encryptedPayload);
...
//   console.log('[Step 7] Encrypted AES Key:', encryptedAesKey);
  ...
  console.log('[Step 9] Authentication Payload:', authenticationPayload);
